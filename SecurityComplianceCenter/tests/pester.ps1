...
Remove-Module SecurityComplianceCenter -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SecurityComplianceCenter.psd1"
Import-Module "$PSScriptRoot\..\SecurityComplianceCenter.psm1" -Force
