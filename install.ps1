<#
	.SYNOPSIS
		Installs the SecurityComplianceCenter Module from github
		
	.DESCRIPTION
		This script installs the SecurityComplianceCenter Module from github.
